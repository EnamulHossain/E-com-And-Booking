...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form id="editForm" class="form form-vertical" action="{{route('rooms.update',$room->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="hotel_id" class="form-select select2"  style="width: 100%">
                                        @foreach($hotels as $hotel)
                                            <option value="{{old('hotel_id',$hotel->id)}}"  {{$room->hotel_id == $hotel->id ? 'selected' : ''}}>{{$hotel->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="amount" name="amount" value="{{$room->amount}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="available" id="active"
                                               value="1" {{($room->available == "1") ? "checked" : ""}} required>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="available" id="inactive"
                                               value="0" {{($room->available == "0") ? "checked" : ""}} required>
