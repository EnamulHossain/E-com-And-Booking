...
<!-- Name Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('name', trans("lang.hotel_name"), ['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::text('name', null,  ['class' => 'form-control','placeholder'=>  trans("lang.hotel_name_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.hotel_name_help") }}
            </div>
        </div>
    </div>
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('hotel_level_id', trans("lang.hotel_hotel_level_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('hotel_level_id', $hotelLevel, null, ['class' => 'select2 form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.hotel_hotel_level_id_help") }}</div>
        </div>
    </div>
    ...
    <!-- Description Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('description', trans("lang.hotel_description"), ['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::textarea('description', null, ['class' => 'form-control','placeholder'=>
             trans("lang.hotel_description_placeholder")  ]) !!}
            <div class="form-text text-muted">{{ trans("lang.hotel_description_help") }}</div>
        </div>
    </div>
