...
@can('salons.index')
    <li class="nav-item has-treeview {{ (Request::is('salon*') || Request::is('requestedSalons*') || Request::is('galleries*') || Request::is('salonReviews*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('availabilityHours*') ) && !Request::is('salonPayouts*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ (Request::is('salon*') || Request::is('requestedSalons*') || Request::is('galleries*') || Request::is('salonReviews*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('availabilityHours*')) && !Request::is('salonPayouts*') ? 'active' : '' }}"> @if($icons)
            ...
            <p>{{trans('lang.salon_plural')}} <i class="right fas fa-angle-left"></i>
            </p>
        </a>
            ...
            @can('salonLevels.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('salonLevels*') ? 'active' : '' }}" href="{!! route('salonLevels.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-list-alt"></i>@endif<p>{{trans('lang.salon_level_plural')}}</p></a>
                </li>
            @endcan
            <li class="nav-item">
                <a class="nav-link {{ Request::is('salons*') ? 'active' : '' }}" href="{!! route('salons.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-list-alt"></i>@endif<p>{{trans('lang.salon_plural')}}</p></a>
            </li>
            @can('requestedSalons.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('requestedSalons*') ? 'active' : '' }}" href="{!! route('requestedSalons.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-list-alt"></i>@endif<p>{{trans('lang.requested_salons_plural')}}</p></a>
                </li>
            @endcan
            @can('salonReviews.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('salonReviews*') ? 'active' : '' }}" href="{!! route('salonReviews.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-comments"></i>@endif<p>{{trans('lang.salon_review_plural')}}</p></a>
                </li>
            @endcan
            @can('galleries.index')
                <li class="nav-item">
...
@can('hotels.index')
    <li class="nav-item has-treeview {{ (Request::is('hotel*') || Request::is('requestedHotels*') || Request::is('galleries*') || Request::is('hotelReviews*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('availabilityHours*') ) && !Request::is('hotelPayouts*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ (Request::is('hotel*') || Request::is('requestedHotels*') || Request::is('galleries*') || Request::is('hotelReviews*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('availabilityHours*')) && !Request::is('hotelPayouts*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fas fa-users-cog"></i>@endif
            <p>{{trans('lang.hotel_plural')}} <i class="right fas fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('hotelLevels.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('hotelLevels*') ? 'active' : '' }}" href="{!! route('hotelLevels.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-list-alt"></i>@endif<p>{{trans('lang.hotel_level_plural')}}</p></a>
                </li>
            @endcan
            <li class="nav-item">
                <a class="nav-link {{ Request::is('hotels*') ? 'active' : '' }}" href="{!! url('hotels') !!}">@if($icons)
                        <i class="nav-icon fas fa-list-alt"></i>@endif<p>{{trans('lang.hotel_plural')}}</p></a>
            </li>
            @can('requestedHotels.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('requestedHotels*') ? 'active' : '' }}" href="{!! route('requestedHotels.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-list-alt"></i>@endif<p>{{trans('lang.requested_hotels_plural')}}</p></a>
                </li>
            @endcan
            @can('hotelReviews.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('hotelReviews*') ? 'active' : '' }}" href="{!! route('hotelReviews.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-comments"></i>@endif<p>{{trans('lang.hotel_review_plural')}}</p></a>
                </li>
            @endcan
            @can('HotelGalleries.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('galleries*') ? 'active' : '' }}" href="{!! route('hotelGalleries.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-image"></i>@endif<p>{{trans('lang.gallery_plural')}}</p></a>
                </li>
            @endcan

                @can('hotelRooms.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('hotelRooms*') ? 'active' : '' }}" href="{!! url('hotelRooms/create') !!}">@if($icons)
                                <i class="nav-icon fas fa-list-alt"></i>@endif<p>Rooms</p></a>
                    </li>
                @endcan
            @can('rooms.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('rooms*') ? 'active' : '' }}" href="{!! url('hotelRooms/create') !!}">@if($icons)
                        <i class="nav-icon fas fa-list-alt"></i>@endif<p>{{trans('lang.rooms')}}</p></a>
            </li>
            @endcan
           {{-- @can('galleries.index')
               <li class="nav-item">
           ...
           @can('availabilityHours.index')
               <li class="nav-item">
                   <a class="nav-link {{ Request::is('availabilityHours*') ? 'active' : '' }}" href="{!! route('availabilityHours.index') !!}">@if($icons)
                           <i class="nav-icon fas fa-business-time"></i>@endif<p>Availability Days</p></a>
               </li>
           @endcan
            @can('addresses.index')
                <li class="nav-item">
...
@can('productcategory.index')
    <li data="{{ Route::currentRouteName() }}" class="nav-item has-treeview {{ Request::is('productcategory*') || Request::is('product*') || Request::is('orderproduct*') ? 'menu-open' : '' }} @if(Request::is('orderproduct.index','orderproduct.create','orderproduct.edit')) menu-open @endif">
        <a href="#" class="nav-link {{  Request::is('productcategory*') || Request::is('product*') || Request::is('orderproduct*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fas fa-pencil-ruler"></i>@endif
            <p>{{trans('lang.e_ecommerce_plural')}} <i class="right fas fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('productcategory.index')
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'productcategory.index' ? 'active' : '' }}" href="{!! route('productcategory.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-list"></i>@endif
                        <p>{{trans('lang.e_productcategory_table')}}</p></a>
                </li>
            @endcan
            @can('colors.index')
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'colors.index' ? 'active' : '' }}" href="{!! route('colors.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-plus-square"></i>@endif<p>Colors</p></a>
                </li>
            @endcan
            @can('product.index')
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'product.index' ? 'active' : '' }}" href="{!! route('product.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-plus-square"></i>@endif<p>{{trans('lang.product_plural')}}</p></a>
                </li>
            @endcan
            @can('orderedproduct.index')
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'orderedproduct.index' ? 'active' : '' }}" href="{!! route('orderedproduct.index') !!}">@if($icons)
                            <i class="nav-icon far fa-plus-square"></i>@endif<p>Orderd Products</p></a>
                </li>
            @endcan
            @can('orderproduct.index')
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'orderproduct.index' ? 'active' : '' }}" href="{!! route('orderproduct.index') !!}">@if($icons)
                            <i class="nav-icon far fa-plus-square"></i>@endif<p>{{trans('lang.orderproduct_plural')}}</p></a>
                </li>
            @endcan
        </ul>
    </li>
...
@can('shipping.index')
    <li class="nav-item has-treeview {{ Request::is('payments*') || Request::is('paymentMethods*') || Request::is('paymentStatuses*')|| Request::is('hotelPayouts*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('payments*') || Request::is('paymentMethods*') || Request::is('paymentStatuses*')|| Request::is('hotelPayouts*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fas fa-money-check-alt"></i>@endif
            <p>Shipping<i class="right fas fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            ...
            @can('shipping.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('payments*') ? 'active' : '' }}" href="{!! route('shipping.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-money-check-alt"></i>@endif<p>Shipping Company</p></a>
                </li>
            @endcan
            @can('shippingrules.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('payments*') ? 'active' : '' }}" href="{!! route('shippingrules.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-money-check-alt"></i>@endif<p>Shipping Rules</p></a>
                </li>
            @endcan
        </ul>
    </li>
...
@can('payments.index')
    <li class="nav-item has-treeview {{ Request::is('payments*') || Request::is('paymentMethods*') || Request::is('paymentStatuses*')|| Request::is('hotelPayouts*') ? 'menu-open' : '' }}">
        ...
        <ul class="nav nav-treeview">
            ...
            @can('hotelPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('hotelPayouts*') ? 'active' : '' }}" href="{!! route('hotelPayouts.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-money-bill-wave"></i>@endif<p>{{trans('lang.hotel_payout_plural')}}</p></a>
                </li>
            @endcan
