...
<aside class="main-sidebar sidebar-{{setting('theme_contrast')}}-{{setting('theme_color')}} shadow">
    <!-- Brand Logo -->
    <a href="{{url('dashboard')}}" class="brand-link border-bottom-0 navbar-olive {{setting('logo_bg_color','bg-white')}}">
        <img src="{{ asset('/images/nefold-png.png') }}" alt="{{ setting('app_name') }}" class="brand-image">
