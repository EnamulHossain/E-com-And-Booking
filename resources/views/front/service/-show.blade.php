               ...
               <div class="row">
                  <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                     <div class="tab-content">
                        ...
                        <div class="tab-pane" id="view2">
                           <a class="image-link" href="{{asset('front_assets/img/product/2.jpg')}}"><img src="{{asset('front_assets/img/product/2.jpg')}}" alt=""></a>							
                        </div>
                        <div class="tab-pane" id="view3">
                           <a class="image-link" href="{{asset('front_assets/img/product/3.jpg')}}"><img src="{{asset('front_assets/img/product/3.jpg')}}" alt=""></a>							
                        </div>
                        <div class="tab-pane" id="view4">
                           <a class="image-link" href="{{asset('front_assets/img/product/13.jpg')}}"><img src="{{asset('front_assets/img/product/13.jpg')}}" alt=""></a>							
                        </div>
                        <div class="tab-pane" id="view5">
                           <a class="image-link" href="{{asset('front_assets/img/product/6.jpg')}}"><img src="{{asset('front_assets/img/product/6.jpg')}}" alt=""></a>							
                        </div>
                     </div>
                     <!-- Nav tabs -->
                     {{-- <ul class="sinple-tab-menu" role="tablist">
                        <li class=" active"><a href="#view1" data-toggle="tab"><img style="width:79px; height:99px;" src="{{asset('front_assets/img/product/15.jpg')}}" alt="" /></a></li>
                        <li><a href="#view2" data-toggle="tab"><img src="{{asset('front_assets/img/product/tab/2.jpg')}}" alt="" /></a></li>
                        <li><a href="#view3" data-toggle="tab"><img src="{{asset('front_assets/img/product/tab/1.jpg')}}" alt="" /></a></li>
                        <li><a href="#view4" data-toggle="tab"><img src="{{asset('front_assets/img/product/tab/4.jpg')}}" alt="" /></a></li>
                        <li><a href="#view5" data-toggle="tab"><img src="{{asset('front_assets/img/product/tab/5.jpg')}}" alt="" /></a></li>
                     </ul> --}}
                  </div>
                  <!-- <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                     <div class="product-simple-content">
                        ...
                        <br/>
                        <div class="quick-add-to-cart">
                           <a href="{!! route('home.checkout') !!}" onclick="addToCart({{$service->id}})"type="button" class="btn btn-lg btn-warning col-sm-12"><span class="lnr lnr-cart"></span>Book Now</a>	
                        </div>
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-3 col-sm-3">
            ...
            <p>Didn't like it? No problem. Return it on the spot at the time of delivery.</p>
         </div>
         <div class="col-md-3 col-sm-3">
            <h4 style="padding:5px 0;"><img src="{{asset('front_assets/img/002-cash-money.png')}}"></h4>
            <h5 style="padding:5px 0;">C.O.D</h5>
            <p>You can pay by Cash or Card at the time of delivery.</p>
         </div>
         <div class="col-md-3 col-sm-3">
...
<div id="snackbarCart">Added item to Cart</div>
<div id="mustlogin">Please login to add to cart</div>
<!-- Icons related Ends -->
@endsection
<script>
