        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 rmv-next-prev">
                <div class="section-title section-title-4">
                    ...
                    <a class="link-a text-center" style="margin-bottom:10px;  width: 134px;" href="{!! route('home.allsaloon') !!}">@lang('front.view_all')</a>
                </div>
                <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-footer">
                                        <div class="service-price">@lang('front.starts_from') &nbsp;<h4>
                                                {!! getPriceColumn($svc) !!}/</h4>@lang('front.hourly')
                                        </div>
                                        <div>
                                            <a
