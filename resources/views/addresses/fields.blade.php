...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            {!! Form::number('latitude', 40.7128, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans("lang.address_latitude_placeholder")]) !!}
            <div class="form-text text-muted">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            {!! Form::number('longitude', -74.0060, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans("lang.address_longitude_placeholder")]) !!}
            <div class="form-text text-muted">
...
@push('scripts')
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBF93O_Wm9XN-MaJ0SeHdPNAHBwNnFTKNw&libraries=places&callback=initializeGoogleMaps"></script>
<script>
    var map;
    var marker;

    function initializeGoogleMaps() {
        var initialLat = parseFloat("{!! old('latitude', 40.7128) !!}"); // Use the initial value or the old submitted value
        var initialLng = parseFloat("{!! old('longitude', -74.006) !!}"); // Use the initial value or the old submitted value
        ...
        marker = new google.maps.Marker({
            ...
            map: map,
            draggable: true // Allow marker to be dragged to update location
        });

        var latitudeInput = document.getElementById("latitude");
        var longitudeInput = document.getElementById("longitude");

        latitudeInput.addEventListener("input", updateMapPosition);
        longitudeInput.addEventListener("input", updateMapPosition);
