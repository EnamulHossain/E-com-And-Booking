...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            ...
            <a href="#loadMediaModal" data-dropzone="logo" data-toggle="modal" data-target="#mediaModal" class="media_select btn btn-outline-{{setting('theme_color','primary')}} btn-sm float-right mt-1">{{ trans('lang.media_select')}}</a>
...
<div class="col-12 custom-field-container">
    @if(isset($paymentMethod))
        ...
        @elseif($paymentMethod['route'] == "googlepay")
            @include('payment_methods.googlepay')
        @endif
    @endif
</div>
@if($customFields)
