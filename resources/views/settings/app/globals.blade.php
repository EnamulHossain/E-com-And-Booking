        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="d-flex flex-column col-sm-12 col-md-6">
                    ...
                    <!-- salon_app_name Field -->
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        {!! Form::label('salon_app_name', trans("lang.app_setting_salon_app_name"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('salon_app_name', setting('salon_app_name'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_salon_app_name_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_salon_app_name_help") }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-8">
                            ...
                            'navbar-dark navbar-olive' => trans('lang.app_setting_olive'),
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-8">
                            ...
                            'text-light navbar-olive' => trans('lang.app_setting_olive'),
                ...
                <div class="d-flex flex-column col-sm-12 col-md-6">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-8">
                            ...
                            <a href="#loadMediaModal" data-dropzone="app_logo" data-toggle="modal" data-target="#mediaModal" class="media_select btn btn-outline-{{setting('theme_color')}} btn-sm float-right mt-1">{{ trans('lang.media_select')}}</a>
