(function($) {
    ...
    $(".click_lang").on('click', function() {
        $(".click_lang_show").slideToggle(400)
    });
...
------------------------------ */
    ...
    $(document).ready(function() {
        ...
        // Set the initial values of the price slider
        var minPrice = 0; // Set your minimum price value here
        var maxPrice = 10000; // Set your maximum price value here
    
        // Check if min_price and max_price are present in the query parameters
        var urlParams = new URLSearchParams(window.location.search);
        var selectedMinPrice = parseInt(urlParams.get('min_price')) || minPrice;
        var selectedMaxPrice = parseInt(urlParams.get('max_price')) || maxPrice;
    
        // Set the initial values of the slider based on the query parameters
        sliderRange.slider({
            range: true,
            min: minPrice,
            max: maxPrice,
        ...
        filterButton.on("click", function() {
            selectedMinPrice = sliderRange.slider("values", 0);
            selectedMaxPrice = sliderRange.slider("values", 1);
            applyFilters(selectedMinPrice, selectedMaxPrice);
        });
        ...
        function applyFilters(minPrice, maxPrice) {
            ...
            // Update the URL parameters with the selected min and max price
