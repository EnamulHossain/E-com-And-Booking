...
class SlideDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('salon.name', function ($slide) {
                return getLinksColumnByRouteName([$slide->salon], 'salons.edit', 'id', 'name');
            })
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'salon.name',
                'name' => 'salon.name',
                'title' => trans('lang.slide_salon_id'),
    ...
    {
        return $model->newQuery()->with("eService")->with("salon")->select("$model->table.*");
    }
