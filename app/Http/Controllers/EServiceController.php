...
class EServiceController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('e_services.create')->with("customFields", isset($html) ? $html : false)->with("category", $category)->with("categoriesSelected", $categoriesSelected)->with("salon", $salon);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('e_services.edit')->with('eService', $eService)->with("customFields", isset($html) ? $html : false)->with("category", $category)->with("categoriesSelected", $categoriesSelected)->with("salon", $salon);
    }
